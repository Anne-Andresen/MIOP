...
public class InfoPageHandler {
    ...
    @FXML
    private Label patientNameLabel;// label anvendes til at vise tekst  med en specifk længde, det er vores teksboks. 

    @FXML
    private Label ageLabel; /* A Label is useful for displaying text that is required to fit within a specific space, and thus may need to use an ellipsis or truncation to size the string to fit*/
    ...
    public void initialize() {
        ...
        // Biomarkers
                ...
                if (ResultBiomarker.biomarkerList[3]==0){ /*Hvis biomarkøren på plads nummer 4 er li nul og derfor ikke
                    tilgængelig sæt creatin resultats boksne til - ellers indsæt resultat af biomarkør i creatin
                    resultat boksen */
                ...
                if (ResultBiomarker.biomarkerList[4]==0){/*Hvis biomarkøren på plads nummer 5 er li nul og derfor ikke
                    tilgængelig sæt platelets resultats boksen til - ellers indsæt resultat af biomarkør i platekets
                    resultat boksen */
                ...
                if (ResultBiomarker.biomarkerList[5]==0){/*Hvis biomarkøren på plads nummer 6 er li nul og derfor ikke
                    tilgængelig sæt gcs resultats boksen til - ellers indsæt resultat af biomarkør i gcs
                    resultat boksen, dette gøres 2 gange fordi samme værdi skal forekomme både i 
                    TOKS og SOFA */

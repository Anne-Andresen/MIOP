...
public class ResultBiomarker {
    ...
    private static int respirationrate; // gwemmer værdierne 
    ...
    */
    ...
    String kreatininTid, String tromboTid, String lakTid) {
        ...
        biomarkerList = new double[11];        // Opretter biomarkør listen den rigtige 
    ...
    private void getBiomarkerDB(){ /*biomarker info er midlertidigt mens vi henter de 11, når vi har alle smider vi den over i den rigtige 
        */ 
    ...
    public static Boolean kreaBool = true; // Her i gennem de respektice 
    ...
    private void compareBiomarker(){ // sammenligner biomarkørerne 
